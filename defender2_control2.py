# This is the controller for red defender2
...
class Nao(Supervisor):  # Inherits Supervisor in order to get the location of other nodes.
    ...
    def run(self):
        ...
        # initial position
        defender2_red_position = [1.25, 0, 0.334]
        ...
        while True:
            ...
            if not in_move_area:
                distance_to_initial = self.calculateDistance(robot_position, defender2_red_position)
                if distance_to_initial > 0.05:  # If not in initial position
                    # turn to initial position
                    angle_to_initial = self.calculateAngle(robot_position, defender2_red_position)
