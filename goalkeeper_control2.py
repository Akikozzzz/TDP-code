# This is the controller for red goalkeeper
...
class Nao(Supervisor):  # Inherits Supervisor in order to get the location of other nodes.
    ...
    def run(self):
        ...
        # initial position
        goalkeeper_red_position = [4, 0, 0.334]
        ...
        while True:
            ...
            if not in_move_area:
                distance_to_initial = self.calculateDistance(robot_position, goalkeeper_red_position)
                if distance_to_initial > 0.05:  # If not in initial position
                    # turn to initial position
                    angle_to_initial = self.calculateAngle(robot_position, goalkeeper_red_position)
